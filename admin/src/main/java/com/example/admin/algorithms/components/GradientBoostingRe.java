...
@Slf4j
public class GradientBoostingRe extends AlComponent {

    private static String pyFile = "gradientBoostingRe.py";

    private RunUtil runUtil = new RunUtil();

    public GradientBoostingRe() {
        params = new FileParams();
        type = ComponentType.LOCAL_PYTHON;
        name = "GradientBoostingRe";
    }
    ...
    private class FileParams extends Params {
        FileParams() {
            ...
            setParam("model","");
            setParam("n_estimators", "100");
            setParam("learning_rate", "0.1");
