...
@Slf4j
public class RandomForestClassifier extends AlComponent {

    private static String pyFile = "random_forest_classifier.py";
    ...
    private class FileParams extends Params {
        FileParams() {
            ...
            setParam("max_depth", "");
            setParam("bootstrap", "");
            setParam("n_estimators", "");
            setParam("warm_start", "");
            setParam("min_samples_split", "");
            setParam("min_samples_leaf", "");
            setParam("min_weight_fraction_leaf", "");
            setParam("n_jobs", "");
            setParam("random_state", "");
